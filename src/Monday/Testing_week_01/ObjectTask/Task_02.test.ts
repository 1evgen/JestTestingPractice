import {CityType, demolishHousesOnTheStreet, getBuildingsWithStaffCountGreaterThen} from './Task_02'
...
// 03. дополните тип GovernmentBuildingType
// 04. заполните объект city, чтобы тесты ниже прошли
...
// 06. Массив строений, где работают больше 500 людей
